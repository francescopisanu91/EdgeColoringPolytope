...
perfectIntegrals = testPersistency.filter_pass_proper_coloring(integrals, n_edges)
for v in perfectIntegrals:
    print(v)    
testPersistency.isPersistentFromBelow(perfectIntegrals, fractionals)
